...
describe('SigningKeyEventsCacheService', () => {
  ...
  //       {
  //         previousModules: ['1', '2', '3'],
  //         currentModules: ['3', '2', '1'],
  //         expected: false,
  //       },
  //       {
  //         previousModules: ['1', '2', '3'],
  //         currentModules: ['1', '2', '3', '4'],
  //         expected: true,
  //       },
  //       {
  //         previousModules: ['1', '2', '2', '3'],
  //         currentModules: ['1', '2', '3'],
  //         expected: false,
  //       },
  //       {
  //         previousModules: ['1', '1', '2', '3'],
  //         currentModules: ['1', '2', '2', '3'],
  //         expected: false,
  //       },
  //       {
  //         previousModules: ['1', '2', '3'],
  //         currentModules: ['1', '1', '2', '3'],
  //         expected: false,
  //       },
  //     ];
  ...
  //       ).toEqual(
  //         testCase.expected,
  //         `Test case ${index + 1} failed: previousModules = ${JSON.stringify(
  //           testCase.previousModules,
  //         )}, currentModules = ${JSON.stringify(
  //           testCase.currentModules,
