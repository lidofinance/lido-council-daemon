...
export const GENESIS_FORK_VERSION_DEVNET_PECTRA5 =
  Version.fromJson('0x10710240');
export const GENESIS_FORK_VERSION_DEVNET_PECTRA6 =
  Version.fromJson('0x10585557');
export const GENESIS_FORK_VERSION_DEVNET_PECTRA7 =
  Version.fromJson('0x10952561');
...
export const GENESIS_FORK_VERSION_BY_CHAIN_ID = {
  ...
  [PECTRA_6_DEVNET_CHAIN_ID]: GENESIS_FORK_VERSION_DEVNET_PECTRA6,
  [PECTRA_7_DEVNET_CHAIN_ID]: GENESIS_FORK_VERSION_DEVNET_PECTRA7,
};
