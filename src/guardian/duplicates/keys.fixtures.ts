...
export const duplicatedKeysOneOperator: RegistryKey[] = [
  {
...
export const duplicatedKeysTwoOperatorsSameModule = [
...
export const duplicatedKeysDiffModules = [...duplicatedKeysOneOperator];
duplicatedKeysDiffModules[2] = {
  ...duplicatedKeysDiffModules[2],
  moduleAddress: '0x23214234234',
};

export const depositedAndUndepositedDuplicateSameOperator = [
  ...duplicatedKeysOneOperator,
];
depositedAndUndepositedDuplicateSameOperator[2] = {
  ...depositedAndUndepositedDuplicateSameOperator[2],
  used: true,
};

export const depositedAndUndepositedDuplicateTwoOperatorsSameModule = [
  ...duplicatedKeysOneOperator,
];
depositedAndUndepositedDuplicateTwoOperatorsSameModule[2] = {
  ...depositedAndUndepositedDuplicateTwoOperatorsSameModule[2],
  operatorIndex: 1001,
  used: true,
};

export const depositedAndUndepositedDuplicateDiffModules = [
  ...duplicatedKeysOneOperator,
];
depositedAndUndepositedDuplicateDiffModules[2] = {
  ...depositedAndUndepositedDuplicateDiffModules[2],
  used: true,
  moduleAddress: '0x23214234234',
};
